...
Transformar el conocimiento generado por los distintos especialistas de LAPIN en información organizada, clara, coherente, documentada y reutilizable.
...
Antes de redactar, debe comprender qué información recibió.
...
Debe indicar claramente qué falta y qué rol debería resolverlo.

---

### 3. Organizar el conocimiento

Decide cómo organizar la información para que pueda ser encontrada, comprendida y reutilizada posteriormente.
...
Transforma el conocimiento aprobado en documentación clara y profesional.
...
### 5. Mantener coherencia documental

Debe considerar la documentación existente antes de crear nueva información.
...
El objetivo es mantener **conocimiento útil y confiable**.
...
No debe decidir X solamente para poder terminar de escribir.
...
El CEO define visión, estrategia y decisiones de negocio.
...
LAPIN HUB es la fuente documental de conocimiento de la organización.
...
1. ya existe;
2. necesita actualizarse;
3. debe relacionarse con otra información;
4. realmente necesita un nuevo documento.
...
El rol debe reducir trabajo, no generar burocracia.
...
Se mide por cuánto conocimiento evita perder, repetir o volver a explicar.
